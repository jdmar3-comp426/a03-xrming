...
export const everyEven = (arr, test) => {
    if (arr.filter(test).toString()==arr.filter(ateven).toString()) {
        return true;
    } else {
        return false;
    }
    function ateven(array) {
...
export const someEven = (arr, test) => {
    if (arr.filter(testandeven()).length>0) {
        return true;
    }
    function testandeven(test,arr) {
